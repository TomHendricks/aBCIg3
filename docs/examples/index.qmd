...
::: {.card-body}
### [Inroduction to Shrinkage LDA](sLDA_tutorial.ipynb)

This file explains the basics of LDA. It starts with a brief overview of what it does and how it works.
It follows up with a coding example and explanation of the used parameters and functions of LDA. 

**Topics**: Overview and Explanation. Coding example. Coding documentation

**Author**: Tom , Dimitra, Jurre, Judith & Yulie (Group 3)
:::
:::
:::
